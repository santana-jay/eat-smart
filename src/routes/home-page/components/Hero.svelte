                ...
                >
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                        <div class="hidden sm:mb-10 sm:flex">
                            ...
                            >
                                Discover the Nutritional Truth Behind Every Bite. <a
                                    href="#"
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600">
                            Eating well doesn't have to be complicated. With <span class="text-indigo-600">Eat Smart</span>, easily scan barcodes to reveal detailed nutritional information, ingredient lists, and potential allergens. Stay informed and make choices that align with your dietary preferences.
                        </p>
